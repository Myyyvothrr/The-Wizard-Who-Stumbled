...
.defines(function()
{
	...
	{
		animSheet: new ig.AnimationSheet('media/conjurer.png', 16, 16),
		...
		attack: function()
		{
			this._spawned = ig.game.spawnEntity(EntityImp, (this.pos.x + this.size.x * 0.5) + (-32 + 32 * Math.random()), (this.pos.y + this.size.x * 0.5) + (-24 + 24 * Math.random()), { });
